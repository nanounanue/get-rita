http --form POST https://www.transtats.bts.gov/DownLoad_Table.asp \
...
VarDesc="DepDelay" \
VarType="Num" \
VarName="DEP_DELAY_NEW" \
VarDesc="DepDelayMinutes" \
VarType="Num" \
VarName="DEP_DEL15" \
VarDesc="DepDel15" \
VarType="Num" \
VarName="DEP_DELAY_GROUP" \
VarDesc="DepartureDelayGroups" \
VarType="Num" \
VarName="DEP_TIME_BLK" \
VarDesc="DepTimeBlk" \
VarType="Char" \
VarName="TAXI_OUT" \
VarDesc="TaxiOut" \
...
VarDesc="ArrDelay" \
VarType="Num" \
VarName="ARR_DELAY_NEW" \
VarDesc="ArrDelayMinutes" \
VarType="Num" \
VarName="ARR_DEL15" \
VarDesc="ArrDel15" \
VarType="Num" \
VarName="ARR_DELAY_GROUP" \
VarDesc="ArrivalDelayGroups" \
VarType="Num" \
VarName="ARR_TIME_BLK" \
VarDesc="ArrTimeBlk" \
VarType="Char" \
VarName="CANCELLED" \
VarDesc="Cancelled" \
VarType="Num" \
VarName="CANCELLATION_CODE" \
VarDesc="CancellationCode" \
VarType="Char" \
VarName="DIVERTED" \
VarDesc="Diverted" \
VarType="Num" \
VarName="CRS_ELAPSED_TIME" \
VarDesc="CRSElapsedTime" \
VarType="Num" \
VarName="ACTUAL_ELAPSED_TIME" \
...
VarType="Num" \
VarName="CARRIER_DELAY" \
VarDesc="CarrierDelay" \
VarType="Num" \
VarName="WEATHER_DELAY" \
VarDesc="WeatherDelay" \
VarType="Num" \
VarName="NAS_DELAY" \
VarDesc="NASDelay" \
VarType="Num" \
VarName="SECURITY_DELAY" \
VarDesc="SecurityDelay" \
VarType="Num" \
VarName="LATE_AIRCRAFT_DELAY" \
VarDesc="LateAircraftDelay" \
VarType="Num" \
VarName="FIRST_DEP_TIME" \
VarDesc="FirstDepTime" \
VarType="Char" \
VarName="TOTAL_ADD_GTIME" \
VarDesc="TotalAddGTime" \
VarType="Num" \
VarName="LONGEST_ADD_GTIME" \
VarDesc="LongestAddGTime" \
VarType="Num" \
VarName="DIV_AIRPORT_LANDINGS" \
VarDesc="DivAirportLandings" \
VarType="Num" \
VarName="DIV_REACHED_DEST" \
VarDesc="DivReachedDest" \
VarType="Num" \
VarName="DIV_ACTUAL_ELAPSED_TIME" \
VarDesc="DivActualElapsedTime" \
VarType="Num" \
VarName="DIV_ARR_DELAY" \
VarDesc="DivArrDelay" \
VarType="Num" \
VarName="DIV_DISTANCE" \
VarDesc="DivDistance" \
VarType="Num" \
VarName="DIV1_AIRPORT" \
VarDesc="Div1Airport" \
VarType="Char" \
VarName="DIV1_AIRPORT_ID" \
VarDesc="Div1AirportID" \
VarType="Num" \
VarName="DIV1_AIRPORT_SEQ_ID" \
VarDesc="Div1AirportSeqID" \
VarType="Num" \
VarName="DIV1_WHEELS_ON" \
VarDesc="Div1WheelsOn" \
VarType="Char" \
VarName="DIV1_TOTAL_GTIME" \
VarDesc="Div1TotalGTime" \
VarType="Num" \
VarName="DIV1_LONGEST_GTIME" \
VarDesc="Div1LongestGTime" \
VarType="Num" \
VarName="DIV1_WHEELS_OFF" \
VarDesc="Div1WheelsOff" \
VarType="Char" \
VarName="DIV1_TAIL_NUM" \
VarDesc="Div1TailNum" \
VarType="Char" \
VarName="DIV2_AIRPORT" \
VarDesc="Div2Airport" \
VarType="Char" \
VarName="DIV2_AIRPORT_ID" \
VarDesc="Div2AirportID" \
VarType="Num" \
VarName="DIV2_AIRPORT_SEQ_ID" \
VarDesc="Div2AirportSeqID" \
VarType="Num" \
VarName="DIV2_WHEELS_ON" \
VarDesc="Div2WheelsOn" \
VarType="Char" \
VarName="DIV2_TOTAL_GTIME" \
VarDesc="Div2TotalGTime" \
VarType="Num" \
VarName="DIV2_LONGEST_GTIME" \
VarDesc="Div1LongestGTime" \
VarType="Num" \
VarName="DIV1_WHEELS_OFF" \
VarDesc="Div1WheelsOff" \
...
VarType="Num" \
VarName="DIV2_WHEELS_OFF" \
VarDesc="Div2WheelsOff" \
VarType="Char" \
VarName="DIV2_TAIL_NUM" \
VarDesc="Div2TailNum" \
VarType="Char" \
VarName="DIV3_AIRPORT" \
VarDesc="Div3Airport" \
VarType="Char" \
VarName="DIV3_AIRPORT_ID" \
VarDesc="Div3AirportID" \
VarType="Num" \
VarName="DIV3_AIRPORT_SEQ_ID" \
VarDesc="Div3AirportSeqID" \
VarType="Num" \
VarName="DIV3_WHEELS_ON" \
VarDesc="Div3WheelsOn" \
VarType="Char" \
VarName="DIV3_TOTAL_GTIME" \
VarDesc="Div3TotalGTime" \
VarType="Num" \
VarName="DIV3_LONGEST_GTIME" \
VarDesc="Div3LongestGTime" \
VarType="Num" \
VarName="DIV3_WHEELS_OFF" \
VarDesc="Div3WheelsOff" \
VarType="Char" \
VarName="DIV3_TAIL_NUM" \
VarDesc="Div3TailNum" \
VarType="Char" \
VarName="DIV4_AIRPORT" \
VarDesc="Div4Airport" \
VarType="Char" \
VarName="DIV4_AIRPORT_ID" \
VarDesc="Div4AirportID" \
VarType="Num" \
VarName="DIV4_AIRPORT_SEQ_ID" \
VarDesc="Div4AirportSeqID" \
VarType="Num" \
VarName="DIV4_WHEELS_ON" \
VarDesc="Div4WheelsOn" \
VarType="Char" \
VarName="DIV4_TOTAL_GTIME" \
VarDesc="Div4TotalGTime" \
VarType="Num" \
VarName="DIV4_LONGEST_GTIME" \
VarDesc="Div4LongestGTime" \
VarType="Num" \
VarName="DIV4_WHEELS_OFF" \
VarDesc="Div4WheelsOff" \
VarType="Char" \
VarName="DIV4_TAIL_NUM" \
VarDesc="Div4TailNum" \
VarType="Char" \
VarName="DIV5_AIRPORT" \
VarDesc="Div5Airport" \
VarType="Char" \
VarName="DIV5_AIRPORT_ID" \
VarDesc="Div5AirportID" \
VarType="Num" \
VarName="DIV5_AIRPORT_SEQ_ID" \
VarDesc="Div5AirportSeqID" \
VarType="Num" \
VarName="DIV5_WHEELS_ON" \
VarDesc="Div5WheelsOn" \
VarType="Char" \
VarName="DIV5_TOTAL_GTIME" \
VarDesc="Div5TotalGTime" \
VarType="Num" \
VarName="DIV5_LONGEST_GTIME" \
VarDesc="Div5LongestGTime" \
VarType="Num" \
VarName="DIV5_WHEELS_OFF" \
VarDesc="Div5WheelsOff" \
VarType="Char" \
VarName="DIV5_TAIL_NUM" \
VarDesc="Div5TailNum" \
VarType="Char" \
                 --print=HBhb
